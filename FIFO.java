...
public class FIFO {
    public static void main(String[] args) throws IOException {
        ...
        for (int j = 0; j < frames; j++)
            buffer[j] = -1; // initialize frames as empty

        System.out.println("Please enter the reference string (one number per line):");
        ...
        System.out.println("\nPage Replacement Table (each column = reference, each row = frame):\n");
